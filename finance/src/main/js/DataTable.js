var DataTable = React
        .createClass(
        {
            ...
            receiveKeyStatisticsData: function(keyStats)
            {
                ...
                myData.freeCashFlow = (keyStats.getFreeCashFlow() ? keyStats
                        .getFreeCashFlow().number : undefined);
                myData.forwardPE = (keyStats.getForwardPE() ? keyStats
                        .getForwardPE().number : undefined);
                myData.dividendYield = (keyStats.getDividendYield() ? keyStats
            ...
            receivePerformanceData: function(performance)
            {
                ...
                myData.threeYearTotalReturn = performance
                        .getThreeYearTotalReturn();
                myData.fiveYearTotalReturn = performance

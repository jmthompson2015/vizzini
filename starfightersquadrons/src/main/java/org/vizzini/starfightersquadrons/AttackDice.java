...
public final class AttackDice
{
     ...
     */
    public AttackDice(final int size)
    {
    ...
    /**
     * @return the number of critical hit values.
     */
    public int getCriticalHitCount()
    {
        return getValueCount(Value.CRITICAL_HIT);
    }
    ...
    /**
     * @return the number of hit values.
     */
    public int getHitCount()
    {
        return getValueCount(Value.HIT);
    }
    ...
    /**
     * Spend a focus token. Change all focus results to hits.
     */
    public void spendFocusToken()
    {
        changeAllToValue(Value.FOCUS, Value.HIT);
    }

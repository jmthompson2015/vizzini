...
/**
 * Provides tests for the <code>TokenCombatComparator</code> class.
 */
public final class TokenCombatComparatorTest
{
    /** Test data. */
    ...
    {
        // Setup.
        final TokenCombatComparator comparator = new TokenCombatComparator();
    ...
    public void sortList()
    {
        ...
        assertThat(tokens.get(0), is(token1));
        assertThat(tokens.get(1), is(token3));
        assertThat(tokens.get(2), is(token2));
        assertThat(tokens.get(3), is(token0));
    }
}

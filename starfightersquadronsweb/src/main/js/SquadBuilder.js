define([ "DualToken", "Pilot", "Team", "Token", "UpgradeCard", "process/Reducer" ], function(DualToken, Pilot, Team,
        Token, UpgradeCard, Reducer)
{
    "use strict";
    var SquadBuilders = [];
    ...
    var HugeShipImperialSquadBuilder = new SquadBuilder(Team.IMPERIAL, "Huge Ships: 168 Points", 2016,
            "Gozanti-class/Raider-class/TIE Advanced", function(store, agent)
            {
                var answer = [];
    ...
    {
        var answer = [];
        answer.push(new Token(store, Pilot.IG_88B, agent, [ UpgradeCard.IG_2000, UpgradeCard.FLECHETTE_CANNON,
                UpgradeCard.AUTOTHRUSTERS ]));
        answer.push(new Token(store, Pilot.IG_88C, agent, [ UpgradeCard.IG_2000, UpgradeCard.ION_CANNON,
                UpgradeCard.AUTOTHRUSTERS ]));
            ...
            store, agent)
    {
        ...
        answer.push(new Token(store, Pilot.CAPTAIN_OICUNN, agent, [ UpgradeCard.PREDATOR, UpgradeCard.YSANNE_ISARD,
    ...
    {
        var answer = [];
        answer.push(new Token(store, Pilot.POE_DAMERON, agent, [ UpgradeCard.VETERAN_INSTINCTS, UpgradeCard.R2_D2,
                UpgradeCard.AUTOTHRUSTERS ]));
        answer.push(new Token(store, Pilot.GOLD_SQUADRON_PILOT, agent, [ UpgradeCard.BTL_A4_Y_WING,
    ...
    SquadBuilders.push(new SquadBuilder(Team.RESISTANCE, "World #2", 2015, "E-Wing/T-70 X-Wing/A-Wing", function(store,
            agent)
    {
        var answer = [];
        answer.push(new Token(store, Pilot.CORRAN_HORN, agent, [ UpgradeCard.PUSH_THE_LIMIT,
                UpgradeCard.FIRE_CONTROL_SYSTEM, UpgradeCard.R2_D2, UpgradeCard.ENGINE_UPGRADE ]));
        answer.push(new Token(store, Pilot.POE_DAMERON, agent, [ UpgradeCard.VETERAN_INSTINCTS, UpgradeCard.R5_P9,
                UpgradeCard.AUTOTHRUSTERS ]));
    ...
    {
        var answer = [];
        answer.push(new Token(store, Pilot.IG_88A, agent, [ UpgradeCard.IG_2000, UpgradeCard.CRACK_SHOT,
                UpgradeCard.FIRE_CONTROL_SYSTEM, UpgradeCard.HEAVY_LASER_CANNON, UpgradeCard.GLITTERSTIM,
                UpgradeCard.AUTOTHRUSTERS ]));
        answer.push(new Token(store, Pilot.IG_88B, agent, [ UpgradeCard.IG_2000, UpgradeCard.CRACK_SHOT,
                UpgradeCard.FIRE_CONTROL_SYSTEM, UpgradeCard.HEAVY_LASER_CANNON, UpgradeCard.GLITTERSTIM,
                UpgradeCard.AUTOTHRUSTERS ]));
        return answer;
    }));
    ...
    SquadBuilders.push(new SquadBuilder(Team.IMPERIAL, "World #4", 2015, "TIE Interceptor/Advanced/Lambda Shuttle",
            ...
            {
                var answer = [];
                answer.push(new Token(store, Pilot.SOONTIR_FEL, agent, [ UpgradeCard.ROYAL_GUARD_TIE,
                        UpgradeCard.PUSH_THE_LIMIT, UpgradeCard.AUTOTHRUSTERS, UpgradeCard.STEALTH_DEVICE ]));
                answer.push(new Token(store, Pilot.DARTH_VADER, agent, [ UpgradeCard.TIE_X1, UpgradeCard.LONE_WOLF,
                        UpgradeCard.ADVANCED_TARGETING_COMPUTER ]));
                answer.push(new Token(store, Pilot.OMICRON_GROUP_PILOT, agent, [ UpgradeCard.EMPEROR_PALPATINE,
    ...
    {
        var answer = [];
        answer.push(new Token(store, Pilot.MIRANDA_DONI, agent,
                [ UpgradeCard.TWIN_LASER_TURRET, UpgradeCard.TACTICIAN ]));
        answer.push(new Token(store, Pilot.WARDEN_SQUADRON_PILOT, agent, [ UpgradeCard.TWIN_LASER_TURRET,
    ...
    SquadBuilders.push(new SquadBuilder(Team.REBEL, "US Nationals #1", 2015, "YT-2400/B-Wings x2", function(store,
            agent)
    {
        var answer = [];
        answer.push(new Token(store, Pilot.DASH_RENDAR, agent, [ UpgradeCard.OUTRIDER, UpgradeCard.LONE_WOLF,
    ...
    {
        var answer = [];
        answer.push(new Token(store, Pilot.CAPTAIN_OICUNN, agent,
    ...
    {
        var answer = [];
        answer.push(new Token(store, Pilot.CHEWBACCA, agent, [ UpgradeCard.MILLENNIUM_FALCON, UpgradeCard.PREDATOR,
                UpgradeCard.LUKE_SKYWALKER, UpgradeCard.C_3PO ]));
        answer.push(new Token(store, Pilot.EADEN_VRILL, agent, [ UpgradeCard.HEAVY_LASER_CANNON,
                UpgradeCard.RECON_SPECIALIST, UpgradeCard.ANTI_PURSUIT_LASERS ]));
        return answer;
    }));
    ...
    SquadBuilders.push(new SquadBuilder(Team.REBEL, "US Nationals #4", 2015, "YT-2400/E-Wing", function(store, agent)
    {
        var answer = [];
        answer.push(new Token(store, Pilot.CORRAN_HORN, agent, [ UpgradeCard.PUSH_THE_LIMIT,
                UpgradeCard.FIRE_CONTROL_SYSTEM, UpgradeCard.R2_D2, UpgradeCard.ENGINE_UPGRADE ]));
        answer.push(new Token(store, Pilot.DASH_RENDAR, agent, [ UpgradeCard.OUTRIDER, UpgradeCard.PREDATOR,
    ...
    {
        var answer = [];
        answer.push(new Token(store, Pilot.IG_88B, agent, [ UpgradeCard.IG_2000, UpgradeCard.VETERAN_INSTINCTS,
                UpgradeCard.FIRE_CONTROL_SYSTEM, UpgradeCard.HEAVY_LASER_CANNON, UpgradeCard.INERTIAL_DAMPENERS,
                UpgradeCard.AUTOTHRUSTERS ]));
        answer.push(new Token(store, Pilot.IG_88C, agent, [ UpgradeCard.IG_2000, UpgradeCard.VETERAN_INSTINCTS,
                UpgradeCard.FIRE_CONTROL_SYSTEM, UpgradeCard.HEAVY_LASER_CANNON, UpgradeCard.INERTIAL_DAMPENERS,
                UpgradeCard.AUTOTHRUSTERS ]));
        return answer;
    }));
    ...
    SquadBuilders.push(new SquadBuilder(Team.SCUM, "EKM", 2015, "Aggressor/M3-A/Z-95/Kihraxz", function(store, agent)
    {
        var answer = [];
    ...
    {
        var answer = [];
        answer.push(new Token(store, Pilot.SYNDICATE_THUG, agent, [ UpgradeCard.TWIN_LASER_TURRET,
    ...
    var CoreSetFirstOrderSquadBuilder = new SquadBuilder(Team.FIRST_ORDER, "First Order TFA Core Set: 39 Points", 2015,
            "TIE/fo Fighters x2", function(store, agent)
            {
                var answer = [];
    ...
    var CoreSetResistanceSquadBuilder = new SquadBuilder(Team.RESISTANCE, "Resistance TFA Core Set: 39 Points", 2015,
            "T-70 X-Wing", function(store, agent)
            {
                var answer = [];
                answer.push(new Token(store, Pilot.POE_DAMERON, agent, [ UpgradeCard.BB_8,
                        UpgradeCard.PROTON_TORPEDOES, UpgradeCard.WEAPONS_GUIDANCE ]));
                return answer;
            });
    ...
    {
        var answer = [];
        answer.push(new Token(store, Pilot.HAN_SOLO, agent, [ UpgradeCard.MILLENNIUM_FALCON, UpgradeCard.PREDATOR,
    ...
    SquadBuilders.push(new SquadBuilder(Team.IMPERIAL, "World #2", 2014, "TIE Phantom/TIE Fighters x4", function(store,
            agent)
    {
        var answer = [];
        answer.push(new Token(store, Pilot.WHISPER, agent, [ UpgradeCard.VETERAN_INSTINCTS,
                UpgradeCard.FIRE_CONTROL_SYSTEM, UpgradeCard.REBEL_CAPTIVE, UpgradeCard.ADVANCED_CLOAKING_DEVICE ]));
    ...
    SquadBuilders.push(new SquadBuilder(Team.IMPERIAL, "US Nationals #1", 2014,
            "TIE Phantom/Interceptor/Lambda Shuttle", function(store, agent)
            {
                var answer = [];
                answer.push(new Token(store, Pilot.WHISPER, agent, [ UpgradeCard.VETERAN_INSTINCTS,
    ...
    {
        var answer = [];
        answer.push(new Token(store, Pilot.LANDO_CALRISSIAN, agent, [ UpgradeCard.DRAW_THEIR_FIRE,
                UpgradeCard.NIEN_NUNB, UpgradeCard.HAN_SOLO ]));
        answer.push(new Token(store, Pilot.CHEWBACCA, agent, [ UpgradeCard.MILLENNIUM_FALCON,
                UpgradeCard.DRAW_THEIR_FIRE, UpgradeCard.C_3PO, UpgradeCard.R2_D2_CREW ]));
        return answer;
    }));
    ...
    // - Biggs
    // Tala Squadron Pilot
    SquadBuilders.push(new SquadBuilder(Team.REBEL, "US Nationals #3", 2014, "YT-1300/X-Wing/Z-95", function(store,
            agent)
    {
        var answer = [];
        answer.push(new Token(store, Pilot.HAN_SOLO, agent, [ UpgradeCard.MILLENNIUM_FALCON,
                UpgradeCard.VETERAN_INSTINCTS, UpgradeCard.LUKE_SKYWALKER, UpgradeCard.C_3PO,
    ...
    SquadBuilders.push(new SquadBuilder(Team.IMPERIAL, "US Nationals #4", 2014, "TIE Fighters x7", function(store,
            agent)
    {
        var answer = [];
    ...
    SquadBuilders.push(new SquadBuilder(Team.REBEL, "US Nationals #5", 2014, "YT-1300/E-Wing", function(store, agent)
    {
        var answer = [];
        answer.push(new Token(store, Pilot.HAN_SOLO, agent, [ UpgradeCard.MILLENNIUM_FALCON, UpgradeCard.DETERMINATION,
                UpgradeCard.LUKE_SKYWALKER ]));
        answer.push(new Token(store, Pilot.CORRAN_HORN, agent, [ UpgradeCard.PUSH_THE_LIMIT,
                UpgradeCard.FIRE_CONTROL_SYSTEM, UpgradeCard.R2_D2 ]));
        return answer;
    }));
    ...
    {
        var answer = [];
        answer.push(new Token(store, Pilot.SYNDICATE_THUG, agent, [ UpgradeCard.BTL_A4_Y_WING,
                UpgradeCard.ION_CANNON_TURRET, UpgradeCard.R4_AGROMECH ]));
        answer.push(new Token(store, Pilot.SYNDICATE_THUG, agent, [ UpgradeCard.BTL_A4_Y_WING,
                UpgradeCard.ION_CANNON_TURRET, UpgradeCard.R4_AGROMECH ]));
        answer.push(new Token(store, Pilot.SYNDICATE_THUG, agent, [ UpgradeCard.BTL_A4_Y_WING,
                UpgradeCard.ION_CANNON_TURRET, UpgradeCard.R4_AGROMECH ]));
    ...
    SquadBuilders.push(new SquadBuilder(Team.IMPERIAL, "World #2", 2013, "TIE Fighters x7", function(store, agent)
    {
        var answer = [];
        answer
                .push(new Token(store, Pilot.HOWLRUNNER, agent,
    ...
    {
        var answer = [];
        answer.push(new Token(store, Pilot.LUKE_SKYWALKER, agent, [ UpgradeCard.SHIELD_UPGRADE, UpgradeCard.R2_D2,
    ...
    SquadBuilders.push(new SquadBuilder(Team.REBEL, "World #5", 2013, "B-Wing/X-Wings x2/Y-Wings x2", function(store,
            agent)
    {
        var answer = [];
        answer.push(new Token(store, Pilot.BLUE_SQUADRON_PILOT, agent));
    ...
    var CoreSetImperialSquadBuilder = new SquadBuilder(Team.IMPERIAL, "Imperial Core Set: 36 Points", 2012,
            "TIE Fighters x2", function(store, agent)
            {
                var answer = [];
    ...
    var CoreSetRebelSquadBuilder = new SquadBuilder(Team.REBEL, "Rebel Core Set: 36 Points", 2012, "X-Wing",
            function(store, agent)
            {
                var answer = [];
                answer.push(new Token(store, Pilot.LUKE_SKYWALKER, agent, [ UpgradeCard.PROTON_TORPEDOES,
                        UpgradeCard.R2_D2 ]));
                return answer;
            });

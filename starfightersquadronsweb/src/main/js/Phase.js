...
var Phase =
{
    ...
    values: [ "planningStart", "planningEnd", "activationStart",
            "activationRevealDial", "activationExecuteManeuver",
            "activationPerformAction", "activationEnd", "combatStart",
            "combatDeclareTarget", "combatRollAttackDice",
            "combatModifyAttackDice", "combatRollDefenseDice",
            "combatModifyDefenseDice", "combatDealDamage", "combatEnd",
            "endStart", "endEnd", ],
};

 ...
 * </dl>
 */
define([ "DamageCard", "ManeuverComputer", "Phase", "Position", "RangeRuler", "RectanglePath", "ShipBase", "Team",
        "Token", ], function(DamageCard, ManeuverComputer, Phase, Position, RangeRuler, RectanglePath, ShipBase, Team,
        Token)
{
    "use strict";

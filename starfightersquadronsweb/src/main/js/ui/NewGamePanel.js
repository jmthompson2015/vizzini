 ...
 */
define([ "MediumAgent", "SimpleAgent", "SquadBuilder", "Team", "ui/HumanAgent", "ui/SquadChooser" ], function(
        MediumAgent, SimpleAgent, SquadBuilder, Team, HumanAgent, SquadChooser)
{
    ...
    NewGamePanel.AgentPanel = React.createClass(
    {
        ...
        createAgent: function(type, name, team, squadBuilder)
        {
            ...
            case "MediumAgent":
                ...
                break;
            case "HumanAgent":
                answer = new HumanAgent(name, team, squadBuilder);
                break;
            default:

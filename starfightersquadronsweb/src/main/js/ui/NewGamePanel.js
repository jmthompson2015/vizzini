 ...
 */
define(
        [ "MediumAgent", "SimpleAgent", "SquadBuilder", "Team", "ui/HumanAgent", "ui/ImageUtilities", "ui/SquadChooser" ],
        function(MediumAgent, SimpleAgent, SquadBuilder, Team, HumanAgent, ImageUtilities, SquadChooser)
        {

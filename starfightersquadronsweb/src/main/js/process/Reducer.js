define(
        [ "Count", "DamageCard", "InitialState", "Pilot", "UpgradeCard", "Value", "process/Action", "process/Selector" ],
        function(Count, DamageCard, InitialState, Pilot, UpgradeCard, Value, Action, Selector)
        {
            ...
            Reducer.tokenIdToValues = function(state, action)
            {
                ...
                case Action.SET_VALUE:
                    ...
                    newTokenIdToValues = Object.assign({}, state);
            ...
            Reducer.root = function(state, action)
            {
                ...
                case Action.SET_COUNT:
                    ...
                    newTokenIdToValues = Object.assign({}, state.tokenIdToValues);

define(["process/DualToken", "Pilot", "Team", "process/Token", "UpgradeCard", "process/Reducer"],
    function(DualToken, Pilot, Team, Token, UpgradeCard, Reducer)
    {
        "use strict";
        var SquadBuilders = [];
        ...
        {
            var answer = [];
            answer.push(new Token(store, Pilot.CAPTAIN_OICUNN, agent, [UpgradeCard.PREDATOR, UpgradeCard.YSANNE_ISARD, UpgradeCard.GUNNER, UpgradeCard.REBEL_CAPTIVE,
        ...
        SquadBuilders.push(new SquadBuilder(Team.IMPERIAL, "US Nationals #1", 2014,
            "TIE Phantom/Interceptor/Lambda Shuttle",
            function(store, agent)
            {
                var answer = [];
                answer.push(new Token(store, Pilot.WHISPER, agent, [UpgradeCard.VETERAN_INSTINCTS,
        ...
        SquadBuilders.push(new SquadBuilder(Team.IMPERIAL, "World #2", 2013, "TIE Fighters x7", function(store, agent)
        {
            var answer = [];
            answer
                .push(new Token(store, Pilot.HOWLRUNNER, agent, [UpgradeCard.STEALTH_DEVICE, UpgradeCard.DETERMINATION]));
            answer.push(new Token(store, Pilot.DARK_CURSE, agent));
            answer.push(new Token(store, Pilot.ACADEMY_PILOT, agent));
            answer.push(new Token(store, Pilot.ACADEMY_PILOT, agent));
            answer.push(new Token(store, Pilot.ACADEMY_PILOT, agent));

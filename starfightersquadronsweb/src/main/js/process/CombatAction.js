define(["AttackDice", "process/DamageDealer", "DefenseDice", "Phase", "Pilot", "RangeRuler", "process/ShipDestroyedAction", "process/TargetLock", "UpgradeCard", "process/Action"],
    function(AttackDice, DamageDealer, DefenseDice, Phase, Pilot, RangeRuler, ShipDestroyedAction, TargetLock, UpgradeCard, Action)
    {
        "use strict";

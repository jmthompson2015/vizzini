define([ "DualToken", "Pilot", "SimpleAgent", "Team", "Token", "TokenFactory", "UpgradeCard" ], function(DualToken,
        Pilot, SimpleAgent, Team, Token, TokenFactory, UpgradeCard)
{
    "use strict";
    ...
    QUnit.test("create() Academy Pilot", function(assert)
    {
        ...
        // Run.
        var result = TokenFactory.create(pilotKey, agent, [ UpgradeCard.MARKSMANSHIP ]);
    ...
    QUnit.test("create() CR90 Corvette", function(assert)
    {
        ...
        // Run.
        var result = TokenFactory.create(pilotKey, agent, [ UpgradeCard.QUAD_LASER_CANNONS, UpgradeCard.SENSOR_TEAM,

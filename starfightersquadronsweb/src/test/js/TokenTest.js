define([ "Bearing", "DamageCard", "Difficulty", "Environment", "Maneuver", "Pilot", "RangeRuler", "Ship",
        "SimpleAgent", "SquadBuilder", "TargetLock", "Team", "Token", "UpgradeCard", "UpgradeType", "ui/HumanAgent" ],
        function(Bearing, DamageCard, Difficulty, Environment, Maneuver, Pilot, RangeRuler, Ship, SimpleAgent,
                SquadBuilder, TargetLock, Team, Token, UpgradeCard, UpgradeType, HumanAgent)
        {
            QUnit.module("Token");

define(["process/ActivationAction", "process/Adjudicator", "process/EnvironmentFactory", "Maneuver", "Position", "process/Action"],
    function(ActivationAction, Adjudicator, EnvironmentFactory, Maneuver, Position, Action)
    {
        "use strict";

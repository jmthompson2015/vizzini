define(["process/Adjudicator", "process/CombatAction", "process/Environment", "process/EnvironmentFactory", "Maneuver", "Phase", "Pilot", "Position", "RangeRuler", "process/SimpleAgent", "process/TargetLock", "Team", "process/Token", "UpgradeCard", "process/Action", "process/Reducer"],
    function(Adjudicator, CombatAction, Environment, EnvironmentFactory, Maneuver, Phase, Pilot, Position, RangeRuler, SimpleAgent, TargetLock, Team, Token, UpgradeCard, Action, Reducer)
    {
        "use strict";
        ...
        QUnit.test("CombatAction.doIt() Ion Torpedoes", function(assert)
        {
            ...
            if (attacker.combatState().isDefenderHit())
            {
                ...
                var token1 = environment.tokens()[1];
                assert.ok(token1);
                assert.equal(token1.ionCount(), 1);
                var token2 = environment.tokens()[2];
                assert.ok(token2);

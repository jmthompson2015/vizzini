define([ "Adjudicator", "AttackDice", "DefenseDice", "Environment", "EnvironmentFactory", "Maneuver",
        "ModifyDefenseDiceAction", "Pilot", "Position", "SimpleAgent", "SquadBuilder", "Team", "Token", "Weapon" ],
        function(Adjudicator, AttackDice, DefenseDice, Environment, EnvironmentFactory, Maneuver,
                ModifyDefenseDiceAction, Pilot, Position, SimpleAgent, SquadBuilder, Team, Token, Weapon)
        {
            ...
            QUnit.test("getDecloakAction()", function(assert)
            {
                ...
                // Run.
                var result = agent.getDecloakAction(environment, adjudicator, token, callback);
            });

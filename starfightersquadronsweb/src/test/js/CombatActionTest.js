define(
        [ "Adjudicator", "CombatAction", "Environment", "EnvironmentFactory", "Maneuver", "Phase", "Pilot", "Position",
                "RangeRuler", "SimpleAgent", "TargetLock", "Team", "Token", "UpgradeCard", "process/Action",
                "process/Reducer" ], function(Adjudicator, CombatAction, Environment, EnvironmentFactory, Maneuver,
                Phase, Pilot, Position, RangeRuler, SimpleAgent, TargetLock, Team, Token, UpgradeCard, Action, Reducer)
        {
            "use strict";

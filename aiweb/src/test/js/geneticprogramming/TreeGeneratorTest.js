define([ "Arithmetic", "Terminal", "TreeGenerator" ], function(Arithmetic, Terminal, TreeGenerator)
{
    "use strict";
    QUnit.module("TreeGenerator");
    ...
    QUnit.test("Grow.generate()", function(assert)
    {
        // Setup.
        var maxDepth = 6;
        var treeGenerator = new TreeGenerator.Grow(functions, terminals, maxDepth);

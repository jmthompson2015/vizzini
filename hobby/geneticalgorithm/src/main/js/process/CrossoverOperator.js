define(function()
{
    ...
    var CrossoverOperator =
    {
        onePointConstantLength: function(genome0, genome1)
        {
            ...
            return CrossoverOperator.assignCreator(answer, "onePointConstantLength");
        },
        ...
        onePointVariableLength: function(genome0, genome1)
        {
            ...
            return CrossoverOperator.assignCreator(answer, "onePointVariableLength");
        },
        ...
        twoPointConstantLength: function(genome0, genome1)
        {
            ...
            else
            {
                ...
                return CrossoverOperator.assignCreator(answer, "twoPointConstantLength");
            }
        },
        ...
        twoPointVariableLength: function(genome0, genome1)
        {
            ...
            else
            {
                ...
                return CrossoverOperator.assignCreator(answer, "twoPointVariableLength");
            }
        },
        ...
        {
            if (length < 2) { throw "Can't selectTwoIndices from length = " + length; }
    ...
    return (
    {
        ...
        onePointConstantLength: CrossoverOperator.onePointConstantLength,
        onePointVariableLength: CrossoverOperator.onePointVariableLength,
        twoPointConstantLength: CrossoverOperator.twoPointConstantLength,
        twoPointVariableLength: CrossoverOperator.twoPointVariableLength,
        uniformConstantLength: CrossoverOperator.uniformConstantLength,
    });
});

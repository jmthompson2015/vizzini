    ...
    sort: function(results)
    {
        ...
        if (results)
        {
            answer = results.sort(function(item0, item1)
            {
                ...
                {
                    var a2b0 = ItemComputer.computeRatioAskToBid(item0);
                    var a2b1 = ItemComputer.computeRatioAskToBid(item1);
                    ...
                    if (a2b0 === a2b1)
                    {
                        var d2s0 = ItemComputer
                                .computeRatioDemandToSupply(item0);
                        var d2s1 = ItemComputer
                                .computeRatioDemandToSupply(item1);

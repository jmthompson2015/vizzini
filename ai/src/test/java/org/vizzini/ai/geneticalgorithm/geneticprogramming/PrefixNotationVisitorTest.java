...
/**
 * Provides tests for the <code>PrefixNotationVisitor</code> class.
 */
public final class PrefixNotationVisitorTest
{
    /** Converter. */
    ...
    public void toEquationBinaryAdd()
    {
        ...
        // Run.
        final String result = PrefixNotationVisitor.toEquation(function);
    ...
    public void toEquationConstant()
    {
        ...
        // Run.
        final String result = PrefixNotationVisitor.toEquation(terminal);

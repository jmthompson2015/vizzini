...
/**
 * Provides unit tests for the <code>PassThroughFunction</code> class.
 */
public final class PassThroughFunctionTest
{
    /** Delta. */
    ...
    public void calculate()
    {
        ...
        assertEquals(-10.0, function0.calculate(-10.0), DELTA);
        assertEquals(10.0, function0.calculate(10.0), DELTA);
    }
    ...
    public void setUp()
    {
        function0 = new PassThroughFunction();
        function1 = new PassThroughFunction();
    }

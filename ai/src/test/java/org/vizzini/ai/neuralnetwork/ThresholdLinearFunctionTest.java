...
/**
 * Provides unit tests for the <code>ThresholdLinearFunction</code> class.
 */
public final class ThresholdLinearFunctionTest
{
    /** Delta. */
    ...
    {
        assertEquals(0.5, function0.calcDerivative(0.0), DELTA);
    ...
    {
        assertEquals(0.5, function0.calculate(0.0), DELTA);
    ...
    public void setUp()
    {
        function0 = new ThresholdLinearFunction();
        function1 = new ThresholdLinearFunction();
    }

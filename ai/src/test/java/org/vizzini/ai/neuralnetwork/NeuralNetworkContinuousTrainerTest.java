...
/**
 * Provides unit tests for the <code>NeuralNetworkContinuousTrainer</code> class.
 */
public final class NeuralNetworkContinuousTrainerTest
{
    ...
    /**
     * Test the <code>NeuralNetworkContinuousTrainer()</code> method.
     */
    @Test
    public void testConstructor()
    {
        ...
        final NeuralNetworkTrainer result = new NeuralNetworkContinuousTrainer(network, examples, IS_VERBOSE, alpha,
                beta);
    ...
    public void testConstructorAlphaOutOfRange()
    {
...

        {
            ...
            try
            {
                new NeuralNetworkContinuousTrainer(network, examples, IS_VERBOSE, alpha, beta);
    ...
    public void testConstructorNull()
    {
        ...
        try
        {
            new NeuralNetworkContinuousTrainer(null, examples, IS_VERBOSE, alpha, beta);
            fail("Should have thrown an exception");
        }
        catch (final IllegalArgumentException e)
        {
        ...
        try
        {
            final NeuralNetwork network = new FeedForwardNetwork(3, 3, 3, new BipolarSigmoidFunction(), false);
            network.fillWeights(0.1);
            new NeuralNetworkContinuousTrainer(network, null, IS_VERBOSE, alpha, beta);
            fail("Should have thrown an exception");
        }
        catch (final IllegalArgumentException e)
        {
    ...
    public void trainEcho()
    {
        ...
        final NeuralNetworkTrainer trainer = new NeuralNetworkContinuousTrainer(network, examples, IS_VERBOSE, alpha,
                beta);

        final double maxError = 0.015;
    ...
    public void trainThirds()
    {
        ...
        // Train
        final double alpha = 0.9;
        final double beta = 1.0 / examples.size();

        final NeuralNetworkTrainer trainer = new NeuralNetworkContinuousTrainer(network, examples, IS_VERBOSE, alpha,
                beta);

        final double maxError = 0.52;

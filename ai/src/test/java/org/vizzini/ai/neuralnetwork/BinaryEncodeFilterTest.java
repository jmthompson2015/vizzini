...
/**
 * Provides tests for the <code>BinaryEncodeFilter</code> class.
 */
public final class BinaryEncodeFilterTest
{
    /** Filter. */
    private BinaryEncodeFilter filter0;

    /** Filter. */
    private BinaryEncodeFilter filter1;
    ...
    public void filter()
    {
        ...
        final BinaryEncodeFilter filter = new BinaryEncodeFilter(encoders);
    ...
    public void setUp()
    {
        ...
        filter0 = new BinaryEncodeFilter(encoders);
        filter1 = new BinaryEncodeFilter(encoders);
    }
    ...
    {
        final String expected = "org.vizzini.ai.neuralnetwork.BinaryEncodeFilter [inputCount=3,outputCount=10]";

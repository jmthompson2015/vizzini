...
/**
 * Provides unit tests for the <code>SigmoidFunction</code> class.
 */
public final class SigmoidFunctionTest
{
    /** Delta. */
    ...
    {
        assertEquals(0.25, function0.calcDerivative(0.0), DELTA);
    ...
    public void setUp()
    {
        function0 = new SigmoidFunction();
        function1 = new SigmoidFunction();
    }

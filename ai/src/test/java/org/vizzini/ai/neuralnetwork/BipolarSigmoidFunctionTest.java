...
/**
 * Provides unit tests for the <code>BipolarSigmoidFunction</code> class.
 */
public final class BipolarSigmoidFunctionTest
{
    /** Delta. */
    ...
    {
        assertThat(function0.getMinimum(), is(-1.0));
    }
    ...
    public void setUp()
    {
        function0 = new BipolarSigmoidFunction();
        function1 = new BipolarSigmoidFunction();
    }

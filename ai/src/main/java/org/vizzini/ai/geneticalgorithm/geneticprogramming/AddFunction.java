 ...
 * @param <T> Type.
 */
public final class AddFunction<T> implements BinaryFunction<T>
{
    /**
     ...
     */
    public static <T> AddFunction<T> createTree(final Converter<T> converter, final List<TreeNode<T>> children)
    {
        AddFunction<T> answer;
        ...
        for (int i = size - 3; i >= 0; i--)
        {
            ...
            answer = new AddFunction<T>(converter, child0, answer);
        }
     ...
     */
    public AddFunction(final Converter<T> converter, final TreeNode<T> child0, final TreeNode<T> child1)
    {
     ...
     * @param children Child nodes.
     */
    private AddFunction(final Converter<T> converter, final List<TreeNode<T>> children)
    {
        delegate = new DefaultFunction<T>(converter, "+", ARITY, children);
    ...
    public boolean equals(final Object object)
    {
        ...
        else
        {
            ...
            final AddFunction<T> another = (AddFunction<T>)object;
    ...
    public T evaluate(final Context context)
    {
        ...
        {
            final String value0 = converter.toString(eval0);
            final String value1 = converter.toString(eval1);
            answer = converter.toT(value0 + value1);
        }
        else
        {
    ...
    @Override
    public AddFunction<T> withChildren(final List<TreeNode<T>> children)
    {
        return new AddFunction<T>(getConverter(), children);
    }

    @Override
    public AddFunction<T> withChildren(final TreeNode<T> child0, final TreeNode<T> child1)
    {
        return new AddFunction<T>(getConverter(), child0, child1);
    }
}

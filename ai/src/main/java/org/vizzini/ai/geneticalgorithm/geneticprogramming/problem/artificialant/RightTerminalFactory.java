 ...
 */
public final class RightTerminalFactory implements Factory<Terminal<Integer>>
{
    /** Converter. */
    ...
    public RightTerminalFactory(final Converter<Integer> converter)
    {
        if (converter == null)
        {

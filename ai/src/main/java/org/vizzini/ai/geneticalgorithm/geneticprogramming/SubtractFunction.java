...
/**
 * Provides an implementation of a subtract function. This function supports the following types.
 * <ol>
 * <li>Double</li>
 * <li>Integer</li>
 * </ol>
 ...
 * @param <T> Type.
 */
public final class SubtractFunction<T> implements BinaryFunction<T>
{
    /** Delegate. */
     ...
     */
    public SubtractFunction(final Converter<T> converter, final TreeNode<T> child0, final TreeNode<T> child1)
    {
     ...
     */
    private SubtractFunction(final Converter<T> converter, final List<TreeNode<T>> children)
    {
        delegate = new DefaultFunction<T>(converter, "-", ARITY, children);
    ...
    public boolean equals(final Object object)
    {
        ...
        else
        {
            ...
            final SubtractFunction<T> another = (SubtractFunction<T>)object;
    ...
    @Override
    public SubtractFunction<T> withChildren(final List<TreeNode<T>> children)
    {
        return new SubtractFunction<T>(getConverter(), children);
    }

    @Override
    public SubtractFunction<T> withChildren(final TreeNode<T> child0, final TreeNode<T> child1)
    {
        return new SubtractFunction<T>(getConverter(), child0, child1);
    }
}

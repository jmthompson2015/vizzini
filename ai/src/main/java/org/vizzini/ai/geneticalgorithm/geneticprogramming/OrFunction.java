...
/**
 * Provides an implementation of an OR function. This function supports the following types.
 * <ol>
 * <li>Boolean</li>
 * <li>Double</li>
 * <li>Integer</li>
 ...
 * @param <T> Type.
 */
public final class OrFunction<T> implements BinaryFunction<T>
{
    /**
     ...
     */
    public static <T> OrFunction<T> createTree(final Converter<T> converter, final List<TreeNode<T>> children)
    {
        OrFunction<T> answer;
        ...
        answer = new OrFunction<T>(converter, child0, child1);

        for (int i = size - 3; i >= 0; i--)
        {
            child0 = children.get(i);
            answer = new OrFunction<T>(converter, child0, answer);
        }
     ...
     */
    public OrFunction(final Converter<T> converter, final TreeNode<T> child0, final TreeNode<T> child1)
    {
     ...
     * @param children Child nodes.
     */
    private OrFunction(final Converter<T> converter, final List<TreeNode<T>> children)
    {
        delegate = new DefaultFunction<T>(converter, "|", ARITY, children);
    ...
    public boolean equals(final Object object)
    {
        ...
        else
        {
            ...
            final OrFunction<T> another = (OrFunction<T>)object;
    ...
    @Override
    public OrFunction<T> withChildren(final List<TreeNode<T>> children)
    {
        return new OrFunction<T>(getConverter(), children);
    }

    @Override
    public OrFunction<T> withChildren(final TreeNode<T> child0, final TreeNode<T> child1)
    {
        return new OrFunction<T>(getConverter(), child0, child1);
    }
}

...
/**
 * Provides a linear scaler filter formatter.
 */
public final class CSVLinearScalerOutputFilterFormat implements LinearScalerOutputFilterFormat
{
    @Override
    public String format(final OutputFilter<double[]> filter)
    {
        String answer = null;

...
/**
 * Provides tests for the <code>DefaultProduct</code> class.
 */
public final class DefaultProductTest
{
    /** Test data. */
    private final TestData testData = new TestData();

    /**
     * Test the <code>getAsk()</code> method.
     */
    @Test
    public void getAsk()
    {
        assertThat(testData.getWoodProduct().getAsk(), is(1.0));
        assertThat(testData.getBowProduct().getAsk(), is(12.0));
    }

    /**
     * Test the <code>getBid()</code> method.
     */
    @Test
    public void getBid()
    {
        assertThat(testData.getWoodProduct().getBid(), is(0.9));
        assertThat(testData.getBowProduct().getBid(), is(8.0));
    }

    /**
     * Test the <code>isCrafted()</code> method.
     */
    @Test
    public void isCrafted()
    {
        assertFalse(testData.getWoodProduct().isCrafted());
        assertTrue(testData.getBowProduct().isCrafted());
    }

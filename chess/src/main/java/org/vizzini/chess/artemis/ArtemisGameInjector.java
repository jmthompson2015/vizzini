...
/**
 * Provides a game injector for artemis chess.
 */
public final class ArtemisGameInjector implements ChessGameInjector
{
    @Override
    ...
    @Override
    public ArtemisEnvironment injectEnvironment()
    {
        return new ArtemisEnvironment();
    }

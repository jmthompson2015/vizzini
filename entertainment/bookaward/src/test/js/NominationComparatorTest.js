define(["Award", "Nomination", "NominationComparator"], function(Award, Nomination, NominationComparator)
{
    ...
    QUnit.test("compare()", function(assert)
    {
        ...
        var nomination2 = createNomination2();
        var nomination3 = createNomination0();
        ...
        assert.equal(NominationComparator.compare(nomination0, nomination3), 0);
        ...
        assert.equal(NominationComparator.compare(nomination1, nomination2), -1);
        ...
        assert.equal(NominationComparator.compare(nomination2, nomination1), 1);
        ...
        assert.equal(NominationComparator.compare(nomination3, nomination0), 0);
    ...
    QUnit.test("equals()", function(assert)
    {
        ...
        assert.equal(NominationComparator.equals(nomination0, nomination3), true);
        ...
        assert.equal(NominationComparator.equals(nomination1, nomination2), false);
        ...
        assert.equal(NominationComparator.equals(nomination2, nomination1), false);
        ...
        assert.equal(NominationComparator.equals(nomination3, nomination0), true);

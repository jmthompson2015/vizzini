define(["Unit", "process/GridFactory", "process/SudokuValidator"],
    function(Unit, GridFactory, SudokuValidator)
    {
        "use strict";
        ...
        QUnit.skip("isCellValid()", function(assert)
        {
            // Setup.
        ...
        QUnit.skip("isCellValidPeers()", function(assert)
        {
            // Setup.
            var originalGrid = GridFactory.createEasy();
            var genome = [9, 1, 2, 5, 3, 2, 7, 6, 9, 7, 2, 2, 3, 8, 9, 7, 2, 5, 8,

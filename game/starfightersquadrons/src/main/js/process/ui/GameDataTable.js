define(["Bearing", "DamageCard", "DamageCardTrait", "Difficulty", "FiringArc", "Maneuver", "Phase", "Pilot", "PlayFormat", "RangeRuler", "Ship", "ShipAction", "ShipBase", "ShipTeam", "Team", "UpgradeCard", "UpgradeHeader", "UpgradeRestriction", "UpgradeType"],
    function(Bearing, DamageCard, DamageCardTrait, Difficulty, FiringArc, Maneuver, Phase, Pilot, PlayFormat, RangeRuler, Ship, ShipAction, ShipBase, ShipTeam, Team, UpgradeCard, UpgradeHeader, UpgradeRestriction, UpgradeType)
    {
        "use strict";
        var GameColumns = [
            {

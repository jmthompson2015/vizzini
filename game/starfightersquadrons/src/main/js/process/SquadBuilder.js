define(["Pilot", "Team", "UpgradeCard", "process/DualToken", "process/Reducer", "process/Squad", "process/Token"],
   function(Pilot, Team, UpgradeCard, DualToken, Reducer, Squad, Token)
   {
      ...
      SquadBuilders.push(new SquadBuilder(Team.SCUM, "Worlds #1", 2017, "JumpMasters x2", function(store, agent)
      {
         var answer = [];
         answer.push(new Token(store, Pilot.DENGAR, agent, [UpgradeCard.PUNISHING_ONE, UpgradeCard.EXPERTISE, UpgradeCard.EXTRA_MUNITIONS, UpgradeCard.PLASMA_TORPEDOES, UpgradeCard.K4_SECURITY_DROID, UpgradeCard.UNHINGED_ASTROMECH, UpgradeCard.GUIDANCE_CHIPS]));
         answer.push(new Token(store, Pilot.TEL_TREVURA, agent, [UpgradeCard.VETERAN_INSTINCTS, UpgradeCard.EXTRA_MUNITIONS, UpgradeCard.PLASMA_TORPEDOES, UpgradeCard.K4_SECURITY_DROID, UpgradeCard.UNHINGED_ASTROMECH, UpgradeCard.GUIDANCE_CHIPS]));
         return answer;
      }));
      ...
      SquadBuilders.push(new SquadBuilder(Team.RESISTANCE, "Worlds #2", 2017, "K-Wing; T-70; X-Wing", function(store, agent)
      {
         ...
         answer.push(new Token(store, Pilot.JESS_PAVA, agent, [UpgradeCard.M9_G8, UpgradeCard.PATTERN_ANALYZER, UpgradeCard.INTEGRATED_ASTROMECH]));
         return answer;
      }));
      ...
      SquadBuilders.push(new SquadBuilder(Team.SCUM, "Worlds #3", 2017, "HWK-290; Lancer-class; Protectorate", function(store, agent)
      {
         ...
         answer.push(new Token(store, Pilot.ASAJJ_VENTRESS, agent, [UpgradeCard.ATTANNI_MINDLINK, UpgradeCard.LATTS_RAZZI]));
         answer.push(new Token(store, Pilot.PALOB_GODALHI, agent, [UpgradeCard.ATTANNI_MINDLINK, UpgradeCard.TWIN_LASER_TURRET]));
         return answer;
      }));
      ...
      SquadBuilders.push(new SquadBuilder(Team.RESISTANCE, "Worlds #4", 2017, "ARC-170; T-70; TIE Fighter; X-Wing", function(store, agent)
      {
         var answer = [];
         answer.push(new Token(store, Pilot.BIGGS_DARKLIGHTER, agent, [UpgradeCard.R4_D6, UpgradeCard.INTEGRATED_ASTROMECH]));
         answer.push(new Token(store, Pilot.JESS_PAVA, agent, [UpgradeCard.ADAPTABILITY, UpgradeCard.R2_D6, UpgradeCard.PATTERN_ANALYZER, UpgradeCard.INTEGRATED_ASTROMECH]));
         answer.push(new Token(store, Pilot.BRAYLEN_STRAMM, agent, [UpgradeCard.GUNNER, UpgradeCard.R3_A2, UpgradeCard.ALLIANCE_OVERHAUL]));
         answer.push(new Token(store, Pilot.CAPTAIN_REX, agent));
         return answer;
      }));
      ...
      SquadBuilders.push(new SquadBuilder(Team.SCUM, "Worlds #5", 2017, "JumpMaster; Lancer-class; Protectorate", function(store, agent)
      {
         ...
         answer.push(new Token(store, Pilot.FENN_RAU, agent, [UpgradeCard.CONCORD_DAWN_PROTECTOR, UpgradeCard.ATTANNI_MINDLINK, UpgradeCard.AUTOTHRUSTERS]));
         answer.push(new Token(store, Pilot.ASAJJ_VENTRESS, agent, [UpgradeCard.ATTANNI_MINDLINK, UpgradeCard.LATTS_RAZZI]));
         answer.push(new Token(store, Pilot.CONTRACTED_SCOUT, agent, [UpgradeCard.ATTANNI_MINDLINK, UpgradeCard.INSPIRING_RECRUIT, UpgradeCard.UNHINGED_ASTROMECH]));
         return answer;
      }));

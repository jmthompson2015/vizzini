define(["Pilot", "pilotstats/DefaultFilters", "pilotstats/EntityFilter", "pilotstats/PilotData", "pilotstats/RangeFilter"],
   function(Pilot, DefaultFilters, EntityFilter, PilotData, RangeFilter)
   {
      "use strict";

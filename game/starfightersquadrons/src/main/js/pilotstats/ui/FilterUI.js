define(["Ship", "Team", "pilotstats/Action", "pilotstats/DefaultFilters", "pilotstats/EntityFilter", "pilotstats/RangeFilter", "../../../../../../../coreweb/src/main/js/ui/InputPanel2"],
   function(Ship, Team, Action, DefaultFilters, EntityFilter, RangeFilter, InputPanel)
   {
      "use strict";
            ...
            DefaultFilters.entityColumns.forEach(function(column)
            {
               ...
               switch (column.key)
               {
                  ...
                  case "shipKey":
                     ...
                     break;
                  case "wave":
                     values = ["1", "2", "3", "4", "5", "6", "7", "8", "9", "Aces", "Huge"];

define(["Ship", "ShipTeam", "Team"], function(Ship, ShipTeam, Team)
{
   ...
   QUnit.test("valuesByTeam() First Order", function(assert)
   {
      ...
      assert.equal(result[i++], ShipTeam.FIRST_ORDER_UPSILON_CLASS_SHUTTLE);
   ...
   QUnit.test("valuesByTeam() Rebel", function(assert)
   {
      ...
      assert.equal(result[i++], ShipTeam.REBEL_U_WING);
   ...
   QUnit.test("valuesByTeam() Scum", function(assert)
   {
      ...
      assert.equal(result[i++], ShipTeam.SCUM_C_ROC_CRUISER);
      ...
      assert.equal(result[i++], ShipTeam.SCUM_M3_A_INTERCEPTOR_V2);

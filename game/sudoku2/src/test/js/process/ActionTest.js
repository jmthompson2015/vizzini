define(["Puzzle", "PuzzleFormat", "SudokuToGo", "process/Action", "process/PuzzleFactory"],
    function(Puzzle, PuzzleFormat, SudokuToGo, Action, PuzzleFactory)
    {
        "use strict";
        QUnit.module("Action");
        ...
        QUnit.test("setPuzzle()", function(assert)
        {
            ...
            puzzle = Puzzle.adjustPossibilites(puzzle, 9);

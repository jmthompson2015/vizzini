define([ "AllyCard", "EventCard", "HeroCard", "LocationCard", "QuestCard", "ImageNameCreator" ], function(AllyCard,
        EventCard, HeroCard, LocationCard, QuestCard, ImageNameCreator)
{
    "use strict";

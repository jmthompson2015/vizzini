define([ "HeroCard", "ImageNameCreator" ], function(HeroCard, ImageNameCreator)
{
    ...
    {
        assert.equal(ImageNameCreator.create(HeroCard.properties[HeroCard.ARAGORN_LEADERSHIP]),
                "http://www.cardgamedb.com/forums/uploads/lotr/ffg_aragorn-core.jpg");
        assert.equal(ImageNameCreator.create(HeroCard.properties[HeroCard.BILBO_BAGGINS_LORE]),

...
/**
 * Provides an implementation of an image splitter for an inventory data count image.
 */
public final class CountImageSplitter implements ImageSplitter
{
    /** Digit width. */
    ...
    public CountImageSplitter(final int digitWidth)
    {

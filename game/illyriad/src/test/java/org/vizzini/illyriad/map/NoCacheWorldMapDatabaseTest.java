...
/**
 * Provides tests for the <code>NoCacheWorldMapDatabase</code> class.
 */
public final class NoCacheWorldMapDatabaseTest
{
    /** Converter. */
    ...
    /**
     * Test the <code>NoCacheWorldMapDatabase()</code> method.
     */
    @Test
    public void testConstructorOneArgBrokenLands()
    {
        // Run.
        final WorldMapDatabase database = new NoCacheWorldMapDatabase(CONVERTER_BL);
    ...
    {
        // Run.
        final WorldMapDatabase database = new NoCacheWorldMapDatabase(CONVERTER_ELGEA);

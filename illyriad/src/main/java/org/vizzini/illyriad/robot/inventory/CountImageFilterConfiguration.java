...
/**
 * Provides a count image filter configuration for a inventory data count image.
 */
public final class CountImageFilterConfiguration
{
     ...
     */
    public CountImageFilterConfiguration()
    {
    ...
    public CountImageFilterConfiguration(final boolean isNormalized0, final float scaleFactor, final float offset,
     ...
     */
    @SuppressWarnings("hiding")
    public CountImageFilterConfiguration(final boolean isNormalized0, final Float[] scaleFactors,

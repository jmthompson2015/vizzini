...
/**
 * Provides a filter to convert a buffered image to input using gray scale images. Result input elements are either 0.0
 * for black or 1.0 for white.
 */
public final class GrayScaleImageInputFilter implements RobotImageInputFilter
{
    /** Maximum image width. */
     ...
     */
    public GrayScaleImageInputFilter(final Dimension maxDimension)
    {
    ...
    public GrayScaleImageInputFilter(final int maxWidth, final int maxHeight)
    {
    ...
    public boolean equals(final Object object)
    {
        ...
        {
            final GrayScaleImageInputFilter another = (GrayScaleImageInputFilter)object;
    ...
    public double[] filter(final RobotImage input)
    {
        ...
        for (int j = 0; j < height; j++)
        {
            for (int i = 0; i < width; i++)
            {
                ...
                answer[index] = sourceColor.getGray() / 255.0;
            }
        }

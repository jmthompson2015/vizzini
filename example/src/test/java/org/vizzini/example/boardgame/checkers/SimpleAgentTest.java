...
public final class SimpleAgentTest
{
    ...
    public void testToString()
    {
        ...
        final String expected = "SimpleAgent[name=agent0,team=CheckersTeam[description=team red,name=Red]]";
    ...
    private Agent create0()
    {
        ...
        return new SimpleAgent("agent0", CheckersTeam.RED, actionGenerator);
    }
    ...
    private Agent create1()
    {
        ...
        return new SimpleAgent("agent1", CheckersTeam.WHITE, actionGenerator);
    }
}

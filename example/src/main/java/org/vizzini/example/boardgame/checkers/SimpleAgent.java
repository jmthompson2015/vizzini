...
/**
 * Provides a simple implementation of a computer agent for checkers.
 */
public final class SimpleAgent implements Agent
{
    ...
    public SimpleAgent(final String name, final CheckersTeam team, final CheckersActionGenerator actionGenerator)
    {
